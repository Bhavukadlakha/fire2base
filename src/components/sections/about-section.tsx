...
export function AboutSection(): JSX.Element {
  return (
    <section id="about" className="w-full bg-secondary/50" aria-labelledby="about-heading">
        ...
        <div className="grid items-center gap-8 lg:grid-cols-2 lg:gap-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-4">
              {aboutDetails.map((detail, index) => (
                <div key={index} className="flex items-center gap-2">
                  {React.cloneElement(detail.icon, { 'aria-hidden': 'true' })}
          ...
          <div className="flex justify-center">
            <Avatar className="w-48 h-48 lg:w-64 lg:h-64 border-4 border-primary shadow-lg">
              <AvatarImage 
                src="/Screenshot 2025-04-27 193958.png" 
                alt="Bhavuk Adlakha"
                loading="lazy"
              />
